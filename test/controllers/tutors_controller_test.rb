...
class TutorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tutor" do
    assert_difference('Tutor.count') do
      post tutors_url, params: { tutor: { alum_id: @tutor.alum_id, prof_id: @tutor.prof_id } }
    end
  ...
  test "should update tutor" do
    patch tutor_url(@tutor), params: { tutor: { alum_id: @tutor.alum_id, prof_id: @tutor.prof_id } }
