...
class ProfsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prof" do
    assert_difference('Prof.count') do
      post profs_url, params: { prof: { correo: @prof.correo, instituto: @prof.instituto, nombre: @prof.nombre, usuario: @prof.usuario } }
    end
  ...
  test "should update prof" do
    patch prof_url(@prof), params: { prof: { correo: @prof.correo, instituto: @prof.instituto, nombre: @prof.nombre, usuario: @prof.usuario } }
