...
class EntsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ent" do
    assert_difference('Ent.count') do
      post ents_url, params: { ent: { fecha: @ent.fecha, notas: @ent.notas, prof_id: @ent.prof_id } }
    end
  ...
  test "should update ent" do
    patch ent_url(@ent), params: { ent: { fecha: @ent.fecha, notas: @ent.notas, prof_id: @ent.prof_id } }
