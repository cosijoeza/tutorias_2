...
class AdminsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin" do
    assert_difference('Admin.count') do
      post admins_url, params: { admin: { nombre: @admin.nombre, password: @admin.password } }
    end
  ...
  test "should update admin" do
    patch admin_url(@admin), params: { admin: { nombre: @admin.nombre, password: @admin.password } }
